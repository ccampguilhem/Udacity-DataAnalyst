...
[Cédric Campguilhem](https://www.github.com/ccampguilhem/Udacity-DataAnalyst), December 2017
...
- alcohol at comparable levels
- less sulfur dioxide in red wine (either free or total)
- higher fixed and volatile acidity in red wine but comparable means in terms of citric acid and lower pH for white wines in general
- higher quantity of sulphates in red wine
- higher quantity of residual sugar in white wine
...
- the negative correlation between alcohol and density, and the positive correlation of density with residual sugar
- the alcohol being positively correlated to quality.
- the strong correlation between total sulfur dioxide which enabled to let one of these parameter out of bivariate analysis.
...
- the correlation of density and quality is different with low and high level of chlorides (a similar effect is observed with white wine)
- but the correlation between high volatile acidity is stronger with red whine than with white one and seems to be the major difference between quality scores for white and red wines
- the correlation with alcohol is visible (and equivalent to the correlation found for white wines)
